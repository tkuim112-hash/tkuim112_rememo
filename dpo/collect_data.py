...
0. 優先判斷：如果【長者剛才說的話】已經觸及或貼近【禁忌話題】的邊緣（是長者
   ...
   改成用場景文字／問題溫暖承接這份情緒，不重複或深究敏感細節本身，把問題轉往
   長者這句話裡比較安全、溫暖的另一個角度或另一個人事物，而不是勉強繼續深挖
   原本那句話（例：長者說「媽媽最後拉著我的手，叫了我的名字」已貼近母親臨終
   禁忌，問題不追問「當時說了什麼」，改問「回到家之後，家裡還有誰在等你」）。
   如果長者剛才說的話沒有這個問題，才進入下面1-4的一般流程。
...
0. 優先判斷：如果【長者最近說的話】已經觸及或貼近【禁忌話題】的邊緣（是長者
   自己主動說的，不是被問出來的），跳過下面「鎖定W維度深挖」的邏輯——改成用
   場景文字／問題溫暖承接這份情緒，不重複或深究敏感細節本身，把問題轉往長者
   這句話裡比較安全、溫暖的另一個角度或另一個人事物，而不是勉強繼續深挖原本
   那句話或硬湊還沒涵蓋的W維度。如果長者最近說的話沒有這個問題，才進入下面
   1-4的一般流程。
